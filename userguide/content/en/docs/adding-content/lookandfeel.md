...
[_nav.scss]: https://github.com/defenseunicorns/defense-unicorns-hugo-theme/blob/main/assets/scss/_nav.scss
...
Any code in this file is included automatically at the end of the theme partial [`scripts.html`](https://github.com/defenseunicorns/defense-unicorns-hugo-theme/blob/main/layouts/partials/head.html).

Both `head.html` and `scripts.html` are then used to build Docsy's [base page layout](https://github.com/defenseunicorns/defense-unicorns-hugo-theme/blob/main/layouts/_default/baseof.html), which is used by all the other page templates:
