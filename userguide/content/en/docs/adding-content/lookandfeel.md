...
[_styles_project]: https://github.com/defenseunicorns/defense-unicorns-hugo-them/blob/main/assets/scss/_styles_project.scss
[_variables_project]: https://github.com/defenseunicorns/defense-unicorns-hugo-them/blob/main/assets/scss/_variables_project.scss
[_variables]: https://github.com/defenseunicorns/defense-unicorns-hugo-them/blob/main/assets/scss/_variables.scss
...
[_nav.scss]: https://github.com/defenseunicorns/defense-unicorns-hugo-them/blob/main/assets/scss/_nav.scss
...
And add the code you need in that file. Your partial code is automatically included just before the end of the theme partial [`head.html`](https://github.com/defenseunicorns/defense-unicorns-hugo-them/blob/main/layouts/partials/head.html). The theme version of [`head-end.html`](https://github.com/defenseunicorns/defense-unicorns-hugo-them/blob/main/layouts/partials/hooks/head-end.html) is empty.
...
Any code in this file is included automatically at the end of the theme partial [`scripts.html`](https://github.com/defenseunicorns/defense-unicorns-hugo-them/blob/main/layouts/partials/head.html).

Both `head.html` and `scripts.html` are then used to build Docsy's [base page layout](https://github.com/defenseunicorns/defense-unicorns-hugo-them/blob/main/layouts/_default/baseof.html), which is used by all the other page templates:
