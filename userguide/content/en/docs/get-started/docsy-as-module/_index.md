...
*   **Copy and edit the source for the [Docsy example site](https://github.com/defenseunicorns/defense-unicorns-hugo-theme-example).** This approach gives you a skeleton structure for your site, with top-level and documentation sections and templates that you can modify as necessary. The example site uses Docsy as a Hugo Module.
*   **Build your own site using the Docsy theme.** Specify the [Docsy theme](https://github.com/defenseunicorns/defense-unicorns-hugo-theme) like any other [Hugo theme](https://gohugo.io/themes/) when creating or updating your site. With this option, you'll get Docsy look and feel, navigation, and other features, but you'll need to specify your own site structure.
