...
require (
	github.com/defenseunicorns/defense-unicorns-hugo-theme v0.6.2 // x-release-please-version
	github.com/defenseunicorns/defense-unicorns-hugo-theme/dependencies v0.6.2 // x-release-please-version
)
